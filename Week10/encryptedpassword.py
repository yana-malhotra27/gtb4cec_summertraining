...
def calculate_password(encrypted_strings):
    total_sum = 0
    ...
    for string in encrypted_strings:
        ...
        # Form the unique token and add it to the total sum
        if first_digit is not None and last_digit is not None:
            unique_token = int(first_digit + last_digit)
            total_sum += unique_token
    
    return total_sum
encrypted_strings = '''prkjfourhpdpxlvlnmz6onetl1
6one3cgxhd
nzeightwofourmz4
...
9szdqjl68seven12
poneightone6'''
encrypted_strings.split('/n')

final_password = calculate_password(encrypted_strings)
